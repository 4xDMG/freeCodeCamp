	...
	$.getJSON('http://ipinfo.io', function(data){
		...
		$.getJSON(apiUrl, function(data) {
			...
			switch (currentWeatherPic) {
				case "01d":
					$('#container').css('background-image', 'url(images/clear-sky.jpg)');
					break;
				case '01n':
					$('#container').css('background-image', 'url(images/clear-sky-night.jpg)');
					break;
				case '02d':
				case '02n':
					$('#container').css('background-image', 'url(images/light-clouds.jpg)');
					break;
				case '03d':
				case '03n':
					$('#container').css('background-image', 'url(images/cloudy.jpg)');
					break;
				case '04d':
				case '04n':
					$('#container').css('background-image', 'url(images/heavy-clouds.jpg)');
					break;
				case '09d':
				case '09n':
					$('#container').css('background-image', 'url(images/light-rain.jpg)');
					break;
				case '10d':
				case '10n':
				...
				case '11d':
				case '11n':
					$('#container').css('background-image', 'url(images/storm.jpg)');
					break;
				case '13d':
				case '13n':
				...
				case '50d':
				case '50n':
					$('#container').css('background-image', 'url(images/fog.jpg)');
					break;
				default:
				break;
			}
